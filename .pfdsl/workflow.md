...
レビューから「検査対象の分類を、検査が正しさの基準とするデータから導く」という指摘を受けた実装者は、採用する前にその分類の出力がどの検査の入力になるかを調べる。
...
検査対象の分類を検査の基準データから導く指摘を採用する前には、この節の「両ホストでの確認」へ戻る。
...
いずれのレビュー手段から受けた指摘でも、検査対象の分類を検査の基準データから導く提案を採用する前には、この節の「両ホストでの確認」へ戻る。
