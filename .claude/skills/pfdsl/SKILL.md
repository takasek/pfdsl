...
Full flag reference: `npx @pfdsl/cli help`. This section documents CLI v0.0.14. If a command above is reported as `unknown command`, the installed/published CLI is older than this skill — check `npx @pfdsl/cli@latest help`.
