...
- **Process 族は subroutine でなく tag で束ねる**: 構造が似た複数 Process は1ノードに畳まず（清水DFD の 1:1 leveling 維持）、共通 tag を付けて共有知識を companion `.md` に外化する。tag は Artifact / Process 両方に付与可（ADR-0019）
