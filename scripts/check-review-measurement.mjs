#!/usr/bin/env node
// Review-Measurement record check for CI (#698).
//
...
// reviewMeasurementStep, so there is one place where the verdict is decided.
//
...
try {
	...
	console.error(`check-review-measurement: ${err.message}`);
	process.exit(2);
}
