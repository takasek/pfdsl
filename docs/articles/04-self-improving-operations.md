...
この痛みへの対処は、プロジェクトの運用そのものを外化することである。
...
運用ハーネスを実際に動かすと、実行が規定の穴を露出させ、振り返りがそれを拾って規定を塞ぎ、再実行で確認するというループが回り始める。
...
この修正もまた、実行が穴を露出させ、振り返りが拾って塞ぐという同じループの一周である。
