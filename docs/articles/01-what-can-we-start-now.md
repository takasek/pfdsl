...
第1部「今、何に着手できるか」。
第2部「構造の見落としは人が拾えない」。
第3部「AI・新規参加者への文脈の口移し」。

## 痛み — 既存のタスク管理は依存関係を表現できない
...
実際、著者のリポジトリでは3件の変更が連続してグラフへの追記を忘れていたことが、後の監査で見つかったことがある。
文章のドキュメントであれば「更新を忘れていた」という指摘で終わるところだが、グラフで捉えると「ある成果物への入力の辺が存在しない」という構造上の欠落として言い当てられる。
その言い当て方のおかげで、3件を同じ型の欠落として一括で見つけることができた。
ただしそれは、欠落が既に構造として書けるようになっていたから拾えたのであって、見つける手間そのものがなくなったわけではない。
