...
単一生成元、循環、孤立プロセスの機械検査が済んでいる領域からは新しい欠陥が出ず、指摘は検査の届かない散文の記述、たとえば配布手順の説明文や参照が連なっていく記述に集中する。
これは経験則ではなく、機械検査が対象にできるのは構造化された依存関係だけであり、散文の整合性そのものは検査の対象外だから起きる帰結である。
