...
8. Every one of the 21 maintained artifacts has a producer and exactly one feedback edge into that producer as the current revision baseline; V001 independently rejects duplicate producers.
