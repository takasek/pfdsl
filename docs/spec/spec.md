...
* `revises:` / `criteria:` を Process に指定: error
...
* `pfdsl ready` / `pfdsl status-set` / `pfdsl audit-sync`（roadmap引数）が `type:` 省略ファイルを `roadmap` として扱う（§15.14）: warning (W006)
