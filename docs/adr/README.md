...
- **ADR-0019** [tags は Artifact / Process 両方に許可](0019-process-tags.md) — subroutine 却下の代替として Process 族を tag で束ね共有知識を companion へ外化、`group` と対称に両種別対象化（status は Artifact 専用据え置き）
